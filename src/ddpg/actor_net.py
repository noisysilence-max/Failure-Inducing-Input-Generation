...
class ActorNet:
    ...
    def __init__(self, num_states, num_actions,l_rate):
        self.g = tf.Graph()
        with self.g.as_default():
            ...
            self.optimizer = tf.train.AdamOptimizer(l_rate).apply_gradients(
    ...
    def create_actor_net(self, num_states, num_actions):
